...
class DetailReviewViewContoller : BaseViewController {
    ...
    private func bind(){
        ...
        output.reviewInfo.bind{[weak self ] reviewModel in
            ...
            self?.ownerReview.attributedText = NSAttributedString(
                string: reviewModel.lessorReview ?? "",
                attributes: self!.reviewAttributes())
            ...
            self?.houseReview.attributedText = NSAttributedString(
                string: reviewModel.review ?? "",
                attributes: self!.reviewAttributes())
    ...
    private func reviewAttributes() -> [NSAttributedString.Key: Any]{
